...
import 'package:flutter_api_samples/examples/ui/text/font_feature.font_feature_contextual_alternates.0.dart'
    as example;
...
void main() {
  testWidgets('shows font features', (WidgetTester tester) async {
    ...
    expect(
        (tester.widget(find.byType(Text).first) as Text).style!.fontFamily, equals('Barriecito'));
