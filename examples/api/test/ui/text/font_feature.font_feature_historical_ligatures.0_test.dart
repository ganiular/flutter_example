...
import 'package:flutter_api_samples/examples/ui/text/font_feature.font_feature_historical_ligatures.0.dart'
    as example;
...
void main() {
  testWidgets('shows font features', (WidgetTester tester) async {
    ...
    expect(
        ...
        equals(
            const <FontFeature>[FontFeature.historicalForms(), FontFeature.historicalLigatures()]));
  });
}
