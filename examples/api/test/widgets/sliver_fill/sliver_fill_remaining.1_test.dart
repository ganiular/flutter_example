...
import 'package:flutter_api_samples/examples/widgets/sliver_fill/sliver_fill_remaining.1.dart'
    as example;
...
void main() {
  ...
  testWidgets('Fills up all available space', (WidgetTester tester) async {
    ...
    for (final Widget widget in tester.widgetList(find.byWidgetPredicate((Widget widget) =>
        (widget is Container) &&
