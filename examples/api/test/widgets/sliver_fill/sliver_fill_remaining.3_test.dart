...
import 'package:flutter_api_samples/examples/widgets/sliver_fill/sliver_fill_remaining.3.dart'
    as example;
...
void main() {
  testWidgets('Shows all elements', (WidgetTester tester) async {
    ...
    expect(
        scroll.physics,
        isA<BouncingScrollPhysics>().having((BouncingScrollPhysics bsp) => bsp.parent, 'parent',
