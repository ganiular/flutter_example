...
import 'package:flutter_api_samples/examples/widgets/sliver_fill/sliver_fill_remaining.0.dart'
    as example;
...
void main() {
  testWidgets('shows how SliverFillRemaining takes up remaining space',
    ...
    expect(find.descendant(of: find.byType(SliverToBoxAdapter), matching: find.byType(Container)),
        findsOneWidget);
    ...
    expect(find.descendant(of: find.byType(SliverFillRemaining), matching: find.byType(Container)),
        findsOneWidget);
    expect(find.byIcon(Icons.sentiment_very_satisfied), findsOneWidget);
    final Icon lowerIcon = tester
        .widget(find.descendant(of: find.byType(SliverFillRemaining), matching: find.byType(Icon)));
