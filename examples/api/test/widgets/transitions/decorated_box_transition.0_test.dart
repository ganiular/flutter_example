...
import 'package:flutter_api_samples/examples/widgets/transitions/decorated_box_transition.0.dart'
    as example;
...
void main() {
  testWidgets('Shows container in 3 second loop', (WidgetTester tester) async {
    ...
    expect(find.descendant(of: find.byType(Center), matching: find.byType(FlutterLogo)),
        findsOneWidget);
    expect(find.ancestor(of: find.byType(FlutterLogo), matching: find.byType(Container)),
        findsAtLeast(1));
