...
import 'package:flutter_api_samples/examples/widgets/transitions/size_transition.0.dart' as example;
    ...
    expect(
        ...
        isA<SizeTransition>()
            ...
            .having(
                ...
                'factor',
                isA<CurvedAnimation>()
                    .having((CurvedAnimation animation) => animation.curve, 'curve',
