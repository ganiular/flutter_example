...
import 'package:flutter_api_samples/examples/widgets/transitions/listenable_builder.2.dart'
    as example;
...
void main() {
  testWidgets('Increments counter', (WidgetTester tester) async {
    ...
    expect(find.descendant(of: find.byType(FloatingActionButton), matching: find.byIcon(Icons.add)),
        findsOneWidget);
