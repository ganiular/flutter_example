...
import 'package:flutter_api_samples/examples/widgets/transitions/listenable_builder.1.dart'
    as example;
...
void main() {
  testWidgets('Tapping FAB increments counter', (WidgetTester tester) async {
    ...
    String getCount() => (tester.widget(find.descendant(
            of: find.byType(ListenableBuilder).last, matching: find.byType(Text))) as Text)
        .data!;
