...
import 'package:flutter_api_samples/examples/widgets/transitions/relative_positioned_transition.0.dart'
    as example;
...
void main() {
  ...
  testWidgets('Animates repeatedly every 2 seconds', (WidgetTester tester) async {
    ...
    expect(
        tester.getSize(find.byType(FlutterLogo)), const Size(200.0 - 2.0 * 8.0, 200.0 - 2.0 * 8.0));
    ...
    expect(
        tester.getSize(find.byType(FlutterLogo)), const Size(100.0 - 2.0 * 8.0, 100.0 - 2.0 * 8.0));
    expect(tester.getBottomRight(find.byType(FlutterLogo)),
