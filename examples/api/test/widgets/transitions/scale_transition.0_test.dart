...
import 'package:flutter_api_samples/examples/widgets/transitions/scale_transition.0.dart'
    as example;
...
void main() {
  testWidgets('Shows flutter logo in transition', (WidgetTester tester) async {
    ...
    expect(find.descendant(of: find.byType(Center), matching: find.byType(ScaleTransition)),
        findsOneWidget);
    expect(
  ...
  testWidgets('Scales every 2 seconds', (WidgetTester tester) async {
    ...
    final Finder transformFinder =
        find.descendant(of: find.byType(Center), matching: find.byType(Transform));
