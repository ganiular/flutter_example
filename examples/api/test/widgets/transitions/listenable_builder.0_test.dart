...
import 'package:flutter_api_samples/examples/widgets/transitions/listenable_builder.0.dart'
    as example;
...
void main() {
  testWidgets('Changing focus changes border', (WidgetTester tester) async {
    ...
    Finder findContainer() => find
        .descendant(
            of: find.byType(example.FocusListenerContainer), matching: find.byType(Container))
        .first;
