...
import 'package:flutter_api_samples/examples/widgets/text_magnifier/text_magnifier.0.dart'
    as example;
...
void main() {
  ...
  testWidgets(
    ...
    variant:
        const TargetPlatformVariant(<TargetPlatform>{TargetPlatform.iOS, TargetPlatform.android}),
