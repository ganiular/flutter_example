...
import 'package:flutter_api_samples/examples/widgets/sliver/sliver_cross_axis_group.0.dart'
    as example;
...
void main() {
  testWidgets('SliverCrossAxisGroup example', (WidgetTester tester) async {
    ...
    expect((renderConstrained.parentData! as SliverPhysicalParentData).paintOffset.dx,
