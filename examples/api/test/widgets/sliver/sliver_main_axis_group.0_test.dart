...
import 'package:flutter_api_samples/examples/widgets/sliver/sliver_main_axis_group.0.dart'
    as example;
...
void main() {
  testWidgets('SliverMainAxisGroup example', (WidgetTester tester) async {
    ...
    final RenderSliverPersistentHeader renderAppBar =
        tester.renderObject<RenderSliverPersistentHeader>(find.byType(SliverAppBar));
    ...
    final RenderSliverToBoxAdapter renderSliverAdapter =
        tester.renderObject<RenderSliverToBoxAdapter>(find.byType(SliverToBoxAdapter));
