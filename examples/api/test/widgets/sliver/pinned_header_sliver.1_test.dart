...
import 'package:flutter_api_samples/examples/widgets/sliver/pinned_header_sliver.1.dart' as example;
...
void main() {
  testWidgets('PinnedHeaderSliver iOS Settings example', (WidgetTester tester) async {
    ...
    expect(
        find.descendant(
            of: find.byType(PinnedHeaderSliver), matching: find.byType(AnimatedOpacity)),
        findsOneWidget);
    ...
    await tester.timedDrag(
        find.byType(CustomScrollView), const Offset(0, -500), const Duration(milliseconds: 500));
