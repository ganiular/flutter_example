...
import 'package:flutter_api_samples/examples/widgets/hardware_keyboard/key_event_manager.0.dart'
    as example;
  ...
  testWidgets('App tracks lifecycle states', (WidgetTester tester) async {
    Future<String> getCapturedKey() async {
      final Widget textWidget =
          tester.firstWidget(find.textContaining('is not handled by shortcuts.'));
