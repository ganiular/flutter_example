...
void main() {
  testWidgets(
    'FocusNode gets focused and unfocused on ColorfulButton tap',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const example.FocusNodeExampleApp(),
      );

      final Element button = tester.element(
        find.byType(example.ColorfulButton),
      );
  ...
  testWidgets(
    'FocusNode updates the text label when focused or unfocused',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const example.FocusNodeExampleApp(),
      );
  ...
  testWidgets(
    'FocusNode does not listen to the key events when unfocused',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const example.FocusNodeExampleApp(),
      );
