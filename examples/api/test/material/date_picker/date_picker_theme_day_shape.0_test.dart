...
import 'package:flutter_api_samples/examples/material/date_picker/date_picker_theme_day_shape.0.dart'
    as example;
...
void main() {
  testWidgets('DatePickerThemeData.dayShape updates day selection shape decoration',
    ...
    ShapeDecoration dayShapeDecoration = tester
    ...
    expect(dayShapeDecoration.shape,
        dayShape.copyWith(side: todayBorder.copyWith(color: todayForegroundColor)));

    dayShapeDecoration = tester
        .widget<DecoratedBox>(find.ancestor(
          of: find.text('20'),
          matching: find.byType(DecoratedBox),
        ))
